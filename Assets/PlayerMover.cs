...
public class PlayerMover : MonoBehaviour
{
    ...
    private void StartMoving(GameObject attacker)
    {
        StartCoroutine(MoveacrossCurve(attacker.transform.position));
    }
    ...
    private IEnumerator MoveacrossCurve(Vector3 attackPosition) 
    {
        ...
        var attackDiraction = attackPosition - startPoint.normalized;
